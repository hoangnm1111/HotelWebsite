...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold b-font text-center">Danh sách phòng</h2>
    ...
    <div class="container-fluid">
                        ...
                        <!-- Check availablity  -->
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                                    <span>Đặt phòng</span>
                                    <button id="chk_avail_btn" onclick="chk_avail_clear()" class="btn shadow-none btn-sm text-secondary d-none">Tải lại</button>
                                </h5>
                                <div class="mb-2">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                                    <span>Tiện nghi</span>
                                    <button id="facilities_btn" onclick="facilities_clear()" class="btn shadow-none btn-sm text-secondary d-none">Tải lại</button>
                                </h5>
                                <?php 
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                                    <span>Đặt phòng</span>
                                    <button id="guests_btn" onclick="guests_clear()" class="btn shadow-none btn-sm text-secondary d-none">Tải lại</button>
                                </h5>
                                <div class="d-flex">
                                    <div class="me-3">
     ...
     <script>
        ...
        function fetch_rooms()
        {
            ...
            xhr.open("GET","admin/ajax/room.php?fetch_rooms&chk_avail="+chk_avail+"&guests="+guests+"&facility_list="+facility_list,true);
